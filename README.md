...
AxiosError: Request failed with status code 404
  ...
  config: {
    ...
    method: 'get',
    url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCHQb90WIYhLUObEc8uVJR6A',
    data: undefined
  },
  request: <ref *1> ClientRequest {
    ...
    _header: 'GET /feeds/videos.xml?channel_id=UCHQb90WIYhLUObEc8uVJR6A HTTP/1.1\r\n' +
      'Accept: application/json, text/plain, */*\r\n' +
      'User-Agent: axios/1.6.8\r\n' +
      'Accept-Encoding: gzip, compress, deflate, br\r\n' +
    ...
    path: '/feeds/videos.xml?channel_id=UCHQb90WIYhLUObEc8uVJR6A',
    _ended: true,
    res: IncomingMessage {
      _readableState: [ReadableState],
      _events: [Object: null prototype],
      ...
      _dumped: false,
      req: [Circular *1],
      responseUrl: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCHQb90WIYhLUObEc8uVJR6A',
      redirects: [],
      [Symbol(kCapture)]: false,
      [Symbol(RequestTimeout)]: undefined
    },
    ...
    _redirectable: Writable {
      ...
      _currentUrl: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCHQb90WIYhLUObEc8uVJR6A',
      [Symbol(kCapture)]: false
    },
    [Symbol(kCapture)]: false,
  ...
  response: {
    ...
    headers: Object [AxiosHeaders] {
      date: 'Sat, 27 Apr 2024 23:04:47 GMT',
    ...
    data: '<!DOCTYPE html>\n' +
      ...
      '  <p>The requested URL <code>/feeds/videos.xml?channel_id=UCHQb90WIYhLUObEc8uVJR6A</code> was not found on this server.  <ins>That’s all we know.</ins>\n'
  }
}
...
AxiosError: Request failed with status code 404
  ...
  config: {
    ...
    method: 'get',
    url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UC-_To7b_NPrxvgG-_de5HRA',
    data: undefined
  },
  request: <ref *1> ClientRequest {
    _events: [Object: null prototype] {
    ...
    _header: 'GET /feeds/videos.xml?channel_id=UC-_To7b_NPrxvgG-_de5HRA HTTP/1.1\r\n' +
      'Accept: application/json, text/plain, */*\r\n' +
      'User-Agent: axios/1.6.8\r\n' +
      'Accept-Encoding: gzip, compress, deflate, br\r\n' +
      'Host: www.youtube.com\r\n' +
    ...
    maxHeaderSize: undefined,
    insecureHTTPParser: undefined,
    path: '/feeds/videos.xml?channel_id=UC-_To7b_NPrxvgG-_de5HRA',
    _ended: true,
    res: IncomingMessage {
      _readableState: [ReadableState],
      _events: [Object: null prototype],
      ...
      _dumped: false,
      req: [Circular *1],
      responseUrl: 'https://www.youtube.com/feeds/videos.xml?channel_id=UC-_To7b_NPrxvgG-_de5HRA',
      redirects: [],
      [Symbol(kCapture)]: false,
      [Symbol(RequestTimeout)]: undefined
    },
    ...
    _redirectable: Writable {
      ...
      _onNativeResponse: [Function (anonymous)],
      _currentRequest: [Circular *1],
      _currentUrl: 'https://www.youtube.com/feeds/videos.xml?channel_id=UC-_To7b_NPrxvgG-_de5HRA',
      [Symbol(kCapture)]: false
    },
    [Symbol(kCapture)]: false,
    [Symbol(kNeedDrain)]: false,
  ...
  response: {
    ...
    statusText: 'Not Found',
    headers: Object [AxiosHeaders] {
      date: 'Sat, 27 Apr 2024 23:04:48 GMT',
      'content-type': 'text/html; charset=UTF-8',
      server: 'YouTube RSS Feeds server',
      'content-length': '1613',
      'x-xss-protection': '0',
